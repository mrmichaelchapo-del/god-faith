...
function prayer() {
  ...
  console.log("Thank You for this day and for the people and blessings in my life.");
  console.log("Please give me wisdom, strength, and kindness.");
  console.log("Help me make good choices and treat others with compassion.");
  console.log("Please watch over my family, friends, and everyone who needs help.");
  console.log("Amen.");
}
...
function prayer2() {
  ...
  console.log("Give me patience when I am frustrated and courage when I am afraid.");
  console.log("Help me learn from my mistakes and grow into a better person.");
  console.log("Please bring peace, safety, and kindness to those around me.");
  console.log("Guide me in everything I do.");
  console.log("Amen.");
}
